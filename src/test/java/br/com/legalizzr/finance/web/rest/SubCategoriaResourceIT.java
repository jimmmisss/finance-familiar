...
class SubCategoriaResourceIT {
    ...
    public static SubCategoria createEntity(EntityManager em) {
        SubCategoria subCategoria = new SubCategoria().nome(DEFAULT_NOME).descricao(DEFAULT_DESCRICAO);
        return subCategoria;
    }
    ...
    public static SubCategoria createUpdatedEntity(EntityManager em) {
        SubCategoria subCategoria = new SubCategoria().nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO);
        return subCategoria;
    }
    ...
    void putNewSubCategoria() throws Exception {
        ...
        updatedSubCategoria.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO);
    ...
    void partialUpdateSubCategoriaWithPatch() throws Exception {
        ...
        partialUpdatedSubCategoria.descricao(UPDATED_DESCRICAO);
    ...
    void fullUpdateSubCategoriaWithPatch() throws Exception {
        ...
        partialUpdatedSubCategoria.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO);
