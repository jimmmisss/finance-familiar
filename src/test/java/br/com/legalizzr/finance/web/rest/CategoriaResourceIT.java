...
class CategoriaResourceIT {
    ...
    public static Categoria createEntity(EntityManager em) {
        Categoria categoria = new Categoria().nome(DEFAULT_NOME).descricao(DEFAULT_DESCRICAO);
        return categoria;
    }
    ...
    public static Categoria createUpdatedEntity(EntityManager em) {
        Categoria categoria = new Categoria().nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO);
        return categoria;
    }
    ...
    void putNewCategoria() throws Exception {
        ...
        updatedCategoria.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO);
