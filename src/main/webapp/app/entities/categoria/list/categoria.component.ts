...
export class CategoriaComponent implements OnInit {
  ...
  constructor(protected categoriaService: CategoriaService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.categorias = [];
    ...
    this.categoriaService
      ...
      .subscribe({
        next: (res: HttpResponse<ICategoria[]>) => {
          ...
          this.paginateCategorias(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
