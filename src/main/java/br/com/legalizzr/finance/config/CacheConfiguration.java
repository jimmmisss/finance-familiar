package br.com.legalizzr.finance.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.com.legalizzr.finance.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.com.legalizzr.finance.repository.UserRepository.USERS_BY_EMAIL_CACHE);
